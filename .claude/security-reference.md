...
Detailed standards reference — not auto-loaded. Read when working on security-relevant code (auth, sessions, crypto, input handling, APIs). The auto-loaded critical rules live in `.claude/security.md`.
